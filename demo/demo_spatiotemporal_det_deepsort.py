...
def parse_args():
    ...
    parser.add_argument('--video',default=r'D:\zlw\_video\8.mp4', help='video file/url') # r'D:\zlw\_video\5.mp4'
    parser.add_argument(
        '--label-map',
    ...
    parser.add_argument(
        '--out-filename',
        default=r'D:\zlw\_long_video\8_ds_demo.mp4',
        help='output filename')
    parser.add_argument(
        '--output',
        default=r"D:\zlw\mmaction2-0.22.0\demo\8_ds.txt",
        help='output txt')
    parser.add_argument(
        '--predict-stepsize',
        default=1,
        type=int,
        help='give out a prediction per n frames') # 8
    parser.add_argument(
        '--output-stepsize',
        default=1,
        type=int,
...
def detection_inference(args, frame_paths):
    ...
    REID_CKPT = r"D:\zlw\OC_SORT-master\trackers\deepsort_tracker\ckpt_faceloss_922.t7"
    tracker = DeepSort(REID_CKPT)
    for frame_path in frame_paths:
        output,img_info = predictor.inference(frame_path, timer)
        # TODO tracker
        online_targets = tracker.update(output[0], img_info["ratio"], img_info["raw_img"])
