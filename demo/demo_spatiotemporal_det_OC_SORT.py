...
def parse_args():
    ...
    parser.add_argument( '--out-filename', default=r'D:\zlw\_long_video\20_ocsort_demo.mp4', help='output filename')
    parser.add_argument( '--output', default=r"D:\zlw\mmaction2-0.22.0\demo\20_ocsort.txt",help='output txt')
    parser.add_argument('--predict-stepsize',default=1,type=int,help='give out a prediction per n frames') # 8
    parser.add_argument('--output-stepsize',default=1,type=int,help=('predict_stepsize % output_stepsize == 0')) # 4
...
def detection_inference(args, frame_paths):
    ...
    tracker = OCSort(det_thresh=0.3, iou_threshold=0.3)
