...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.4,
        help='the threshold of human action score')  # 0.4 不框选总比错框好
    parser.add_argument('--label-map', default=r'D:\zlw\mmaction2-0.22.0\tools\data\ava\label_map.txt',help='label map file')
    parser.add_argument('--device', type=str, default='cuda:0', help='CPU/CUDA device option')
    parser.add_argument('--video',default=r'D:\zlw\_video\20.mp4', help='video file/url') # r'D:\zlw\_video\5.mp4'
    parser.add_argument( '--out-filename', default=r'D:\zlw\_long_video\20_by_demo.mp4',help='output filename')
    parser.add_argument('--output',default=r"D:\zlw\mmaction2-0.22.0\demo\20_byte.txt",help='output txt')
    parser.add_argument('--predict-stepsize',default=1,type=int,help='give out a prediction per n frames') # 8
    parser.add_argument('--output-stepsize',default=1, type=int,
        help=('show one frame per n frames in the demo, we should have: '
              'predict_stepsize % output_stepsize == 0')) # 4
    parser.add_argument( '--output-fps',default=30,type=int,help='the fps of demo video output')
    parser.add_argument(
        '--cfg-options',
        nargs='+',
        action=DictAction,
...
def detection_inference(args, frame_paths):
    ...
    for frame_path in frame_paths:
        ...
        # TODO tracker
        online_targets = tracker.update(output[0], img_info["ratio"])
        result = torch.tensor(online_targets, dtype=torch.float32)
