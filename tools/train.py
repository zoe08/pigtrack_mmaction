...
def parse_args():
    ...
    parser.add_argument('--config', default=r'D:\zlw\mmaction2-0.22.0\configs\detection\ava\slowfast_kinetics_pretrained_r50_4x16x1_20e_ava_rgb.py', help='train config file path')
